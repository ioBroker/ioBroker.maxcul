...
function startAdapter(options) {
  ...
  adapter.on("stateChange", (id, state) => {
    ...
    if (type === "weekProfile") {
      if (
        /setPointUntilTime/.test(name) &&
        state.val !== formatTimeString(state.val)
      )
        adapter.setForeignState(id, formatTimeString(state.val));
    ...
    if (type === "vacationConfig") {
      if (/untilDate/.test(name) && state.val !== formatUntilDate(state.val))
        adapter.setForeignState(id, formatUntilDate(state.val));
      return;
    }
    ...
    if (name === "display") {
      ...
      adapter.log.debug(
        "sendSetDisplayActualTemperature(" + channel + ", " + state.val + ")",
      );
    ...
    if (name === "enablePairingMode") {
      ...
      if (
        max.pairModeEnabled === true ||
        max.pairModeEnabled === "true" ||
        max.pairModeEnabled === 1 ||
        max.pairModeEnabled === "1"
      ) {
...
function sendDayProfile(channel) {
  ...
  adapter.setState(
    sendId + "_01_setPointTemp",
    timers[channel]._01_setPointTemp,
    true,
  );
  adapter.setState(
    sendId + "_01_setPointUntilTime",
    timers[channel]._01_setPointUntilTime,
    true,
  );
  adapter.setState(
    sendId + "_02_setPointTemp",
    timers[channel]._02_setPointTemp,
    true,
  );
  adapter.setState(
    sendId + "_02_setPointUntilTime",
    timers[channel]._02_setPointUntilTime,
    true,
  );
  adapter.setState(
    sendId + "_03_setPointTemp",
    timers[channel]._03_setPointTemp,
    true,
  );
  adapter.setState(
    sendId + "_03_setPointUntilTime",
    timers[channel]._03_setPointUntilTime,
    true,
  );
  adapter.setState(
    sendId + "_04_setPointTemp",
    timers[channel]._04_setPointTemp,
    true,
  );
  adapter.setState(
    sendId + "_04_setPointUntilTime",
    timers[channel]._04_setPointUntilTime,
    true,
  );
  adapter.setState(
    sendId + "_05_setPointTemp",
    timers[channel]._05_setPointTemp,
    true,
  );
  adapter.setState(
    sendId + "_05_setPointUntilTime",
    timers[channel]._05_setPointUntilTime,
    true,
  );
  adapter.setState(
    sendId + "_06_setPointTemp",
    timers[channel]._06_setPointTemp,
    true,
  );
  adapter.setState(
    sendId + "_06_setPointUntilTime",
    timers[channel]._06_setPointUntilTime,
    true,
  );
  adapter.setState(
    sendId + "_07_setPointTemp",
    timers[channel]._07_setPointTemp,
    true,
  );
  adapter.setState(
    sendId + "_07_setPointUntilTime",
    timers[channel]._07_setPointUntilTime,
    true,
  );
  adapter.setState(
    sendId + "_08_setPointTemp",
    timers[channel]._08_setPointTemp,
    true,
  );
  adapter.setState(
    sendId + "_08_setPointUntilTime",
    timers[channel]._08_setPointUntilTime,
    true,
  );
  adapter.setState(
    sendId + "_09_setPointTemp",
    timers[channel]._09_setPointTemp,
    true,
  );
  adapter.setState(
    sendId + "_09_setPointUntilTime",
    timers[channel]._09_setPointUntilTime,
    true,
  );
  adapter.setState(
    sendId + "_10_setPointTemp",
    timers[channel]._10_setPointTemp,
    true,
  );
  adapter.setState(
    sendId + "_10_setPointUntilTime",
    timers[channel]._10_setPointUntilTime,
    true,
  );
  adapter.setState(
    sendId + "_11_setPointTemp",
    timers[channel]._11_setPointTemp,
    true,
  );
  adapter.setState(
    sendId + "_11_setPointUntilTime",
    timers[channel]._11_setPointUntilTime,
    true,
  );
  adapter.setState(
    sendId + "_12_setPointTemp",
    timers[channel]._12_setPointTemp,
    true,
  );
  adapter.setState(
    sendId + "_12_setPointUntilTime",
    timers[channel]._12_setPointUntilTime,
    true,
  );
  adapter.setState(
    sendId + "_13_setPointTemp",
    timers[channel]._13_setPointTemp,
    true,
  );
  adapter.setState(
    sendId + "_14_setPointUntilTime",
    timers[channel]._13_setPointUntilTime,
    true,
  );
...
function sendInfo(channel) {
  ...
  if (
    (timers[channel].mode !== undefined ||
      timers[channel].desiredTemperature !== undefined) &&
    timers[channel].mode !== 2
  ) {
  ...
  if (
    timers[channel].comfortTemperature !== undefined ||
    ...
    if (timers[channel].comfortTemperature === undefined) {
      ...
      adapter.getForeignState(
        channel + ".config.comfortTemperature",
        (err, state) => {
          if (!state || state.val === null || state.val === undefined) {
            state = state || {};
            state.val = 21;
    ...
    if (timers[channel].minimumTemperature === undefined) {
      count2++;
      adapter.getForeignState(
        channel + ".config.minimumTemperature",
        (err, state) => {
          if (!state || state.val === null || state.val === undefined) {
            state = state || {};
            state.val = 4.5;
    ...
    if (timers[channel].maximumTemperature === undefined) {
      count2++;
      adapter.getForeignState(
        channel + ".config.maximumTemperature",
        (err, state) => {
          if (!state || state.val === null || state.val === undefined) {
            state = state || {};
            state.val = 30.5;
    ...
    if (timers[channel].windowOpenTemperature === undefined) {
      count2++;
      adapter.getForeignState(
        channel + ".config.windowOpenTemperature",
        (err, state) => {
          if (!state || state.val === null || state.val === undefined) {
            state = state || {};
            state.val = 12;
  ...
  if (
    timers[channel].boostDuration !== undefined ||
    ...
    if (timers[channel].boostDuration === undefined) {
      count3++;
      adapter.getForeignState(
        channel + ".valveConfig.boostDuration",
        (err, state) => {
          if (!state || state.val === null || state.val === undefined) {
            state = state || {};
            state.val = 5;
    ...
    if (timers[channel].boostValvePosition === undefined) {
      count3++;
      adapter.getForeignState(
        channel + ".valveConfig.boostValvePosition",
        (err, state) => {
          if (!state || state.val === null || state.val === undefined) {
            state = state || {};
            state.val = 100;
    ...
    if (timers[channel].decalcificationDay === undefined) {
      count3++;
      adapter.getForeignState(
        channel + ".valveConfig.decalcificationDay",
        (err, state) => {
          if (!state || state.val === null || state.val === undefined) {
            state = state || {};
            state.val = 0;
    ...
    if (timers[channel].decalcificationHour === undefined) {
      count3++;
      adapter.getForeignState(
        channel + ".valveConfig.decalcificationHour",
        (err, state) => {
          if (!state || state.val === null || state.val === undefined) {
            state = state || {};
            state.val = 12;
    ...
    if (timers[channel].maxValveSetting === undefined) {
      count3++;
      adapter.getForeignState(
        channel + ".valveConfig.maxValveSetting",
        (err, state) => {
          if (!state || state.val === null || state.val === undefined) {
            state = state || {};
            state.val = 100;
    ...
    if (timers[channel].valveOffset === undefined) {
      count3++;
      adapter.getForeignState(
        channel + ".valveConfig.valveOffset",
        (err, state) => {
          if (!state || state.val === null || state.val === undefined) {
            state = state || {};
            state.val = 0;
  ...
  if (
    (timers[channel].send_0_saturday !== undefined &&
      timers[channel].send_0_saturday === true) ||
    (timers[channel].send_1_sunday !== undefined &&
      timers[channel].send_1_sunday === true) ||
    (timers[channel].send_2_monday !== undefined &&
      timers[channel].send_2_monday == true) ||
    (timers[channel].send_3_tuesday !== undefined &&
      timers[channel].send_3_tuesday === true) ||
    (timers[channel].send_4_wednesday !== undefined &&
      timers[channel].send_4_wednesday === true) ||
    (timers[channel].send_5_thursday !== undefined &&
      timers[channel].send_5_thursday === true) ||
    (timers[channel].send_6_friday !== undefined &&
      timers[channel].send_6_friday === true)
  ) {
    ...
    if (timers[channel]._01_setPointTemp === undefined) {
      count4++;
      adapter.getForeignState(
        channel + ".weekProfile." + weekDay + "._01_setPointTemp",
        (err, state) => {
          if (
            !state ||
            state.val === null ||
    ...
    if (timers[channel]._01_setPointUntilTime === undefined) {
      count4++;
      adapter.getForeignState(
        channel + ".weekProfile." + weekDay + "._01_setPointUntilTime",
        (err, state) => {
          if (!state || state.val === null || state.val === undefined) {
            state = state || {};
            state.val = "";
    ...
    if (timers[channel]._02_setPointTemp === undefined) {
      count4++;
      adapter.getForeignState(
        channel + ".weekProfile." + weekDay + "._02_setPointTemp",
        (err, state) => {
          if (
            !state ||
            state.val === null ||
    ...
    if (timers[channel]._02_setPointUntilTime === undefined) {
      count4++;
      adapter.getForeignState(
        channel + ".weekProfile." + weekDay + "._02_setPointUntilTime",
        (err, state) => {
          if (!state || state.val === null || state.val === undefined) {
            state = state || {};
            state.val = "";
    ...
    if (timers[channel]._03_setPointTemp === undefined) {
      count4++;
      adapter.getForeignState(
        channel + ".weekProfile." + weekDay + "._03_setPointTemp",
        (err, state) => {
          if (
            !state ||
            state.val === null ||
    ...
    if (timers[channel]._03_setPointUntilTime === undefined) {
      count4++;
      adapter.getForeignState(
        channel + ".weekProfile." + weekDay + "._03_setPointUntilTime",
        (err, state) => {
          if (!state || state.val === null || state.val === undefined) {
            state = state || {};
            state.val = "";
    ...
    if (timers[channel]._04_setPointTemp === undefined) {
      count4++;
      adapter.getForeignState(
        channel + ".weekProfile." + weekDay + "._04_setPointTemp",
        (err, state) => {
          if (
            !state ||
            state.val === null ||
    ...
    if (timers[channel]._04_setPointUntilTime === undefined) {
      count4++;
      adapter.getForeignState(
        channel + ".weekProfile." + weekDay + "._04_setPointUntilTime",
        (err, state) => {
          if (!state || state.val === null || state.val === undefined) {
            state = state || {};
            state.val = "";
    ...
    if (timers[channel]._05_setPointTemp === undefined) {
      count4++;
      adapter.getForeignState(
        channel + ".weekProfile." + weekDay + "._05_setPointTemp",
        (err, state) => {
          if (
            !state ||
            state.val === null ||
    ...
    if (timers[channel]._05_setPointUntilTime === undefined) {
      count4++;
      adapter.getForeignState(
        channel + ".weekProfile." + weekDay + "._05_setPointUntilTime",
        (err, state) => {
          if (!state || state.val === null || state.val === undefined) {
            state = state || {};
            state.val = "";
    ...
    if (timers[channel]._06_setPointTemp === undefined) {
      count4++;
      adapter.getForeignState(
        channel + ".weekProfile." + weekDay + "._06_setPointTemp",
        (err, state) => {
          if (
            !state ||
            state.val === null ||
    ...
    if (timers[channel]._06_setPointUntilTime === undefined) {
      count4++;
      adapter.getForeignState(
        channel + ".weekProfile." + weekDay + "._06_setPointUntilTime",
        (err, state) => {
          if (!state || state.val === null || state.val === undefined) {
            state = state || {};
            state.val = "";
    ...
    if (timers[channel]._07_setPointTemp === undefined) {
      count4++;
      adapter.getForeignState(
        channel + ".weekProfile." + weekDay + "._07_setPointTemp",
        (err, state) => {
          if (
            !state ||
            state.val === null ||
    ...
    if (timers[channel]._07_setPointUntilTime === undefined) {
      count4++;
      adapter.getForeignState(
        channel + ".weekProfile." + weekDay + "._07_setPointUntilTime",
        (err, state) => {
          if (!state || state.val === null || state.val === undefined) {
            state = state || {};
            state.val = "";
    ...
    if (timers[channel]._08_setPointTemp === undefined) {
      count4++;
      adapter.getForeignState(
        channel + ".weekProfile." + weekDay + "._08_setPointTemp",
        (err, state) => {
          if (
            !state ||
            state.val === null ||
    ...
    if (timers[channel]._08_setPointUntilTime === undefined) {
      count4++;
      adapter.getForeignState(
        channel + ".weekProfile." + weekDay + "._08_setPointUntilTime",
        (err, state) => {
          if (!state || state.val === null || state.val === undefined) {
            state = state || {};
            state.val = "";
    ...
    if (timers[channel]._09_setPointTemp === undefined) {
      count4++;
      adapter.getForeignState(
        channel + ".weekProfile." + weekDay + "._09_setPointTemp",
        (err, state) => {
          if (
            !state ||
            state.val === null ||
    ...
    if (timers[channel]._09_setPointUntilTime === undefined) {
      count4++;
      adapter.getForeignState(
        channel + ".weekProfile." + weekDay + "._09_setPointUntilTime",
        (err, state) => {
          if (!state || state.val === null || state.val === undefined) {
            state = state || {};
            state.val = "";
    ...
    if (timers[channel]._10_setPointTemp === undefined) {
      count4++;
      adapter.getForeignState(
        channel + ".weekProfile." + weekDay + "._10_setPointTemp",
        (err, state) => {
          if (
            !state ||
            state.val === null ||
    ...
    if (timers[channel]._10_setPointUntilTime === undefined) {
      count4++;
      adapter.getForeignState(
        channel + ".weekProfile." + weekDay + "._10_setPointUntilTime",
        (err, state) => {
          if (!state || state.val === null || state.val === undefined) {
            state = state || {};
            state.val = "";
    ...
    if (timers[channel]._11_setPointTemp === undefined) {
      count4++;
      adapter.getForeignState(
        channel + ".weekProfile." + weekDay + "._11_setPointTemp",
        (err, state) => {
          if (
            !state ||
            state.val === null ||
    ...
    if (timers[channel]._11_setPointUntilTime === undefined) {
      count4++;
      adapter.getForeignState(
        channel + ".weekProfile." + weekDay + "._11_setPointUntilTime",
        (err, state) => {
          if (!state || state.val === null || state.val === undefined) {
            state = state || {};
            state.val = "";
    ...
    if (timers[channel]._12_setPointTemp === undefined) {
      count4++;
      adapter.getForeignState(
        channel + ".weekProfile." + weekDay + "._12_setPointTemp",
        (err, state) => {
          if (
            !state ||
            state.val === null ||
    ...
    if (timers[channel]._12_setPointUntilTime === undefined) {
      count4++;
      adapter.getForeignState(
        channel + ".weekProfile." + weekDay + "._12_setPointUntilTime",
        (err, state) => {
          if (!state || state.val === null || state.val === undefined) {
            state = state || {};
            state.val = "";
    ...
    if (timers[channel]._13_setPointTemp === undefined) {
      count4++;
      adapter.getForeignState(
        channel + ".weekProfile." + weekDay + "._13_setPointTemp",
        (err, state) => {
          if (
            !state ||
            state.val === null ||
    ...
    if (timers[channel]._13_setPointUntilTime === undefined) {
      count4++;
      adapter.getForeignState(
        channel + ".weekProfile." + weekDay + "._13_setPointUntilTime",
        (err, state) => {
          if (!state || state.val === null || state.val === undefined) {
            state = state || {};
            state.val = "";
  ...
  if (timers[channel].mode !== undefined && timers[channel].mode === 2) {
    ...
    if (timers[channel].vacationTemperature === undefined) {
      count5++;
      adapter.getForeignState(
        channel + ".vacationConfig.vacationTemperature",
        (err, state) => {
          if (!state || state.val === null || state.val === undefined) {
            state = state || {};
            state.val = 17;
    ...
    if (timers[channel].untilDate === undefined) {
      count5++;
      adapter.getForeignState(
        channel + ".vacationConfig.untilDate",
        (err, state) => {
          if (!state || state.val === null || state.val === undefined) {
            state = state || {};
            state.val = "";
      ...
      adapter.getForeignObject(task.id, (err, obj) => {
        if (!obj) {
          ...
          adapter.setForeignObject(task.id, task.obj, (err, res) => {
            adapter.log.info(
              "object " + adapter.namespace + "." + task.id + " created",
            );
            setImmediate(processTasks);
          });
        } else {
          ...
          if (changed) {
            ...
            adapter.setForeignObject(obj._id, obj, (err, res) => {
              adapter.log.info(
                "object " + adapter.namespace + "." + obj._id + " created",
              );
              setImmediate(processTasks);
            });
          } else {
...
function setStates(obj) {
  ...
  for (const state in obj.data) {
    ...
    if (
      state === "mode" &&
      timers[adapter.namespace + "." + id] &&
      timers[adapter.namespace + "." + id].requestRunning
    ) {
    ...
    if (
      ...
      adapter.log.debug(
        id + ": Ignore desiredTemperature triggered by polling: " + val,
      );
      adapter.log.debug(
        id +
          ": Set initially desiredTemperature after polling: " +
          timers[adapter.namespace + "." + id].requestRunning,
      );
      adapter.log.debug(
        id +
          ": Set initially mode after polling: " +
          timers[adapter.namespace + "." + id].requestRunningMode,
      );
      timers[adapter.namespace + "." + id].desiredTemperature =
        timers[adapter.namespace + "." + id].requestRunning;
      timers[adapter.namespace + "." + id].mode =
        timers[adapter.namespace + "." + id].requestRunningMode;
      timers[adapter.namespace + "." + id].requestRunning = false;
      timers[adapter.namespace + "." + id].requestRunningMode = false;

      setImmediate(
        (channel) => sendInfo(channel),
        0,
...
function formatTimeString(timeString) {
  ...
  if (timeStringNum !== null) {
    ...
    if (formattedTimeString.length >= 3) {
      ...
      formattedTimeString = (
        Math.round(parseInt(formattedTimeString, 10) / 5) * 5
      ).toString();
      if (formattedTimeString[formattedTimeString.length - 2] === "6")
        formattedTimeString = (
          parseInt(formattedTimeString, 10) + 40
        ).toString();
      if (leadingZeros !== null)
        formattedTimeString = leadingZeros.join("").concat(formattedTimeString);
      formattedTimeString = formattedTimeString.substring(
        formattedTimeString.length - 4,
      );
    }
    ...
    if (formattedTimeString.length === 3)
      formattedTimeString =
        "0" +
        formattedTimeString.substr(0, 1) +
        ":" +
        formattedTimeString.substr(1);
    if (formattedTimeString.length === 4)
      formattedTimeString =
        formattedTimeString.substr(0, 2) + ":" + formattedTimeString.substr(2);
...
function formatUntilDate(untilDateTimeString) {
  ...
  if (dateTimeStringNum !== null && dateTimeStringNum.length >= 12) {
    ...
    formattedMinuteString = (
      Math.round(parseInt(formattedMinuteString) / 30) * 30
    ).toString();
    ...
    if (
      ...
      (/[0][0-9]/.test(formattedMonthString) ||
        /[1][0-2]/.test(formattedMonthString)) &&
      (/[0-2][0-9]/.test(formattedDayString) ||
        /[3][0-1]/.test(formattedDayString)) &&
...
function createThermostat(data, prefix) {
  ...
  obj = {
    _id:
      adapter.namespace + "." + data.serial + ".config.windowOpenTemperature",
    common: {
  ...
  obj = {
    _id:
      adapter.namespace + "." + data.serial + ".valveConfig.boostValvePosition",
    common: {
  ...
  obj = {
    _id:
      adapter.namespace + "." + data.serial + ".valveConfig.decalcificationDay",
    common: {
  ...
  obj = {
    _id:
      ...
      "." +
      data.serial +
      ".valveConfig.decalcificationHour",
    common: {
  ...
  obj = {
    _id:
      ...
      "." +
      data.serial +
      ".vacationConfig.vacationTemperature",
    common: {
  ...
  obj = {
    ...
    common: {
      name:
        ...
        "Thermostat " +
        data.serial +
        " set vacation until date (dd-MM-yyyy HH:mm)",
      type: "string",
      read: true,
      write: true,
      role: "until.date",
      ...
      adapter.getForeignState(
        ...
        (err, untilDate) => {
          if (state && state.val !== null && state.val !== undefined) {
            ...
            if (oldMode === 2) {
              adapter.log.info(
                "Poll-Timeout: Reset Polling for device " +
                  id +
                  " : " +
                  oldMode +
                  ", " +
...
function connect() {
  ...
  max = new Max(
    adapter.config.baseAddress,
    true,
    adapter.config.serialport,
    parseInt(adapter.config.baudrate, 10) || 9600,
  );
    ...
    thermostatTimer = setInterval(() => {
      ...
      for (const id in objects) {
        if (
          ...
          (objects[id].native.type === 1 ||
            objects[id].native.type === 2 ||
            objects[id].native.type === 3)
        ) {
          if (
            devices[objects[id].native.src] &&
            (!devices[objects[id].native.src].lastReceived ||
              now - devices[objects[id].native.src].lastReceived >
                adapter.config.scanner * 60000)
          ) {
          ...
          if (devices[objects[id].native.src].lastReceived && timers[id]) {
            ...
            adapter.log.debug(
              id +
                "  Request: " +
                timers[id].requestRunningMode +
                "," +
                timers[id].requestRunning +
                "  Last-Received: " +
                received,
            );
            if (
              timers[id].requestRunning &&
              now - devices[objects[id].native.src].lastReceived > 300000
            ) {
              pollTimers["reset_" + id] = setTimeout(
                (resetPDevice) => {
      ...
      adapter.getObjectView(
        ...
        (err, res) => {
          for (let i = 0, l = res.rows.length; i < l; i++) {
            objects[res.rows[i].id] = res.rows[i].value;
            if (
              objects[res.rows[i].id].native &&
              objects[res.rows[i].id].native.src
            ) {
              devices[objects[res.rows[i].id].native.src] =
                objects[res.rows[i].id];
            }
          }
          connect();
